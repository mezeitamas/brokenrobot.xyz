...
![Baseline architecture](./baseline-architecture-s3.svg)

Now, let's explore how users can access the website from various locations across the globe.

![Baseline architecture - access from locations across the globe](./baseline-architecture-s3-geo.svg)
...
![Target architecture](./target-architecture-s3-cdn.svg)
...
![Target architecture - access from locations across the globe](./target-architecture-s3-cdn-geo.svg)
...
![Target architecture - CloudFront Function](./target-architecture-s3-cdn-cloudfront-function.svg)
