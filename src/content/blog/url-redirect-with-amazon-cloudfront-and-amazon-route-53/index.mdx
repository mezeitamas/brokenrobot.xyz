...
import baselineArchitecture from '../advanced-static-website-hosting-with-amazon-s3-and-cloudfront/target-architecture-s3-cdn.png';
import baselineArchitectureCloudFrontFunction from '../advanced-static-website-hosting-with-amazon-s3-and-cloudfront/target-architecture-s3-cdn-cloudfront-function.png';
...
<BlogPostPicture
    src={baselineArchitectureCloudFrontFunction}
    alt="Baseline architecture - CloudFront Function"
/>
