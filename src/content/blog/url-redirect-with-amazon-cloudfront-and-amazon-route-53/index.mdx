...
![Baseline architecture](../advanced-static-website-hosting-with-amazon-s3-and-cloudfront/target-architecture-s3-cdn.svg)

**CloudFront functions** play (and will play) an important role, so it worth to have a look at this diagram as well:

![Baseline architecture - CloudFront Function](../advanced-static-website-hosting-with-amazon-s3-and-cloudfront/target-architecture-s3-cdn-cloudfront-function.svg)
