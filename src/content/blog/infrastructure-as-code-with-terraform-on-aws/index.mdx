...
**// TODO: add note for the long general iac introduction**
...
However as you see on the diagram one part of the development workflow is still manual, and that is the infrastructure changes.
...
-   **Push changes to the repository**: Once the changes are made, they are pushed to the source code repository.
...
This means that when adjustments are needed - whether to improve performance, enhance security, or adapt to traffic fluctuations - someone must log in to the management console and manually make the required updates. This can be time-consuming and error prone, especially when dealing with large-scale or complex infrastructures.

While the current setup allows for effective management, the manual process for infrastructure changes could benefit from automation.
...
**// TODO: mention that imperative languages are used for example Pulumi, but they describe the desired state not the steps to achieve it**
...
This streamlined process is automated, consistent, fast, and repeatable, significantly reducing the likelihood of human errors and ensuring the infrastructure remains up-to-date.
...
**// TODO: agent-based vs agent-less (agent vs agentless)**
...
**// TODO: https://circleci.com/topics/infrastructure-as-code-iac/**

**// TODO: categorize articles**
