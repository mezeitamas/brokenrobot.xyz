    ...
    server: {
        ...
        headers: {
            'Content-Security-Policy':
                "default-src 'none'; connect-src 'self'; manifest-src 'self'; img-src 'self' 'unsafe-inline'; script-src 'none'; style-src 'self' 'unsafe-inline'; object-src 'none'; frame-ancestors 'none'; form-action 'none'; base-uri 'none'; require-trusted-types-for 'script';",
            'Permissions-Policy':
